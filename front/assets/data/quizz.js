var _quizzData = [
	...
	{
		'theme' : 'html5',
		'question' : 'Dans un document HTML, comment peut-on sélectionner les élements qui ne sont pas de type &lt;span&gt; ?',
		'reponses' : 
		[
			'$("*").filter(":not(span)")', 
			'$("*").not("")', 
	...
	{
		'theme' : 'php',
		'question' : 'La boucle for ($i=0 ; $i$lt;=3 ; $i++ ) { echo $i; }...',
		'reponses' : 
		[
	...
	{
		'theme' : 'Accessibilité',
		'question' : 'Dans quel cas le code suivant posera-t-il des problèmes d\'accessibilité ?<code>$lt;a id="lien" href="index.html" title="Page d\'accueil"&gt; $lt;/a$gt;<br>#lien { background-image: url(\'icone-home.png\'); }</code>',
		'reponses' : 
		[
	...
	{
		'theme' : 'Accessibilité',
		'question' : 'L\'attribut "tabindex" permet :',
		'reponses' : 
		[
	...
	{
		'theme' : 'JEE',
		'question' : 'Quel Enterprise Bean est défini sans interface de vue client ?',
		'reponses' : 
		[
			'CMP Entity bean', 
	...
	{
		'theme' : 'JEE',
		'question' : 'Qu\'est ce qui ne devrait PAS être utilisé pour partager des données entre des servlets d\'une application distribuée ?',
		'reponses' : 
		[
			'Enterprise Java Beans', 
			'Attributs de ServletContext', 
			'Attributs de HttpSession', 
			'Base de données'
		],
		'answer' : 2,
		'difficulty' : 1 //1,2 ou 3
	...
	{
		'theme' : 'JEE',
		'question' : 'Une servlet doit acquérir une source de données avec un JNDI naming lookup.<br>Quel est le meilleur endroit pour le faire ?',
		'reponses' : 
		[
		    'constructeur',
			'init()', 
	...
	{
		'theme' : 'JEE',
		'question' : 'Lequel n\'est pas un serveur d\'application dans un environnement JEE ?',
		'reponses' : 
		[
			'JBOSS', 
			'JONAS', 
